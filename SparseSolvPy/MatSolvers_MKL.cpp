...
bool MatSolversEigenMKL::solveMLKpardisoBase(const slv_int size0,
                                             const MType &matA, VType *vecB,
                                             VType *results, int mat_mode,
                                             int num_para = 1) {
...
// ● MKL Pardisoで解く(対称)
//=======================================================*/
bool MatSolversEigenMKL::solveMLKpardisoSym(const slv_int size0,
                                            const SparseMat &matA, double *vecB,
                                            double *results, int num_para = 1) {
  bool bl = solveMLKpardisoBase<SparseMat, double>(size0, matA, vecB, results,
                                                   1, num_para);
  return bl;
}
...
bool MatSolversEigenMKL::solveMLKpardisoSym(const slv_int size0,
                                            ...
                                            int num_para = 1) {
  bool bl = solveMLKpardisoBase<SparseMatC, dcomplex>(size0, matA, vecB,
                                                      results, 3, num_para);
  return bl;
}
...
// ● MKL Pardisoで解く(非対称)
//=======================================================*/
bool MatSolversEigenMKL::solveMLKpardiso(const slv_int size0,
                                         const SparseMat &matA, double *vecB,
                                         double *results, int num_para = 1) {
  bool bl = solveMLKpardisoBase<SparseMat, double>(size0, matA, vecB, results,
                                                   11, num_para);
...
//=======================================================*/
bool MatSolversEigenMKL::solveMLKpardiso(const slv_int size0,
                                         const SparseMatC &matA, dcomplex *vecB,
                                         dcomplex *results, int num_para = 1) {
  bool bl = solveMLKpardisoBase<SparseMatC, dcomplex>(size0, matA, vecB,
                                                      results, 13, num_para);
  return bl;
}
...
// ● MKL Pardisoで解く(非対称)
//=======================================================*/
bool MatSolvers::solveMLKpardiso(const slv_int size0, const SparseMat &matA,
                                 double *vecB, double *results, int num_para) {
  const int n = size0;
  /* スパース形式コピー */
  slv_int *ia = new int[n + 1];
  auto row_ptr = matA.matrix->matrix.outerIndexPtr();
...
//=======================================================*/
bool MatSolvers::solveMLKpardiso(const slv_int size0, const SparseMatC &matA,
                                 dcomplex *vecB, dcomplex *results,
                                 int num_para) {
  const slv_int n = size0;
  /* スパース形式コピー */
