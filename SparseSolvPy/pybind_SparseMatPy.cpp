...
PYBIND11_MODULE(SparseSolvPy, m) {
  ...
  py::class_<MatSolvers>(m, "MatSolvers")
      ...
      .def("solveICCG_py",
           py::overload_cast<const int, const double, const int, const double,
                             const SparseMat &, py::array_t<double>,
                             py::array_t<double>, bool>(
               &MatSolvers::solveICCG_py))
      .def("solveICCG_py",
           py::overload_cast<const int, const double, const int, const double,
                             const SparseMatC &,
                             py::array_t<std::complex<double>>,
                             py::array_t<std::complex<double>>, bool>(
               &MatSolvers::solveICCG_py))
      .def("solveICCGwithABMC_py",
           py::overload_cast<const int, const double, const int, const double,
                             const SparseMat &, py::array_t<double>,
                             py::array_t<double>, int, int, bool>(
               &MatSolvers::solveICCGwithABMC_py))
      .def("solveICMRTR_py",
           py::overload_cast<const int, const double, const int, const double,
                             const SparseMat &, py::array_t<double>,
                             py::array_t<double>, bool>(
               &MatSolvers::solveICMRTR_py))
      .def("solveICMRTR_py",
           py::overload_cast<const int, const double, const int, const double,
                             const SparseMatC &,
                             py::array_t<std::complex<double>>,
               ...
               &MatSolvers::solveICMRTR_py))
      .def("solveSGSMRTR_py",
           py::overload_cast<const int, const double, const int,
                             const SparseMat &, py::array_t<double>,
                             py::array_t<double>, bool>(
               &MatSolvers::solveSGSMRTR_py))
      .def("solveSGSMRTR_py",
           py::overload_cast<const int, const double, const int,
                             const SparseMatC &,
                             py::array_t<std::complex<double>>,
