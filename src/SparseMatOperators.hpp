...
private:
  ...
  static void mat_vec_product(DType3 **ans, const Mat1 &matA,
                              const DType2 *const vec);
  /* 行列ベクトル積(std::vectorとの) */
  template <typename Mat1, typename DType3>
  static void mat_vec_product(std::vector<DType3> &ans, const Mat1 &matA,
                              const std::vector<double> &vec);
  template <typename Mat1>
  static void mat_vec_product(std::vector<dcomplex> &ans, const Mat1 &matA,
                              const std::vector<dcomplex> &vec);
  /* 行列ベクトル積(std::vectorと。結果はEigen) */
  template <typename Mat1, typename DType3>
  static void mat_vec_product(DType3 &ans, const Mat1 &matA,
                              const std::vector<double> &vec);
  template <typename Mat1>
  static void mat_vec_product(Eigen::VectorXcd &ans, const Mat1 &matA,
                              const std::vector<dcomplex> &vec);
  /* 足し算オペレータ(matAにmatBを加える(a1*A+a2*B)。Bの位置を行方向にpos1、列方向にpos2だけずらす。)
   */
  template <typename Mat1, typename Mat2, typename Mat3, typename DType1,
            typename DType2>
  static void plus_operators(Mat3 &mat3, const Mat1 &matA, const Mat2 &matB,
                             double a1, double a2, slv_int pos1, slv_int pos2);
  /* matAにa1*matBを加える。 開始位置はposだけずらす */
  template <typename Mat1, typename Mat2, typename DType1, typename DType2,
            typename DType3>
  static void MatSelfPlus(Mat1 &matA, const Mat2 &matB, const DType3 a1,
                          const slv_int pos1, const slv_int pos2);
  /**/
  /* その他 */
  /**/
  /* 実数→複素化 */
  ...
  static void makeSubMat(Mat1 &mat_ans, const Mat1 &targetMat, slv_int range1a,
                         slv_int range1b, slv_int range2a, slv_int range2b);
  /* 列rangeBを境に、行列を2つに分ける。行rangeAより下は削除する */
  template <typename Mat1, typename DType>
  static void MatDiv(const Mat1 &targetMat, Mat1 &matK11, Mat1 &matK12,
                     slv_int rangeA, slv_int rangeB);
  /* 下三角行列を取得 */
  template <typename Mat1, typename DType>
  ...
  static void IC_decomp(Mat1 &mat_ans, const Mat1 &mat1, DTypeD *diagD,
                        const double accela);
  /**/
  /* 対角スケーリング */
  static void diagScaling(SparseMatBaseD &mat_ans, const SparseMatBaseD &mat1,
                          double *trans_vec, const double *ori_vec);
  /**/
  /* 対角スケーリング(複素) */
  static void diagScalingComplex(SparseMatBaseC &mat_ans,
                                 const SparseMatBaseC &mat1,
                                 dcomplex *trans_vec, const dcomplex *ori_vec);
  /**/
  ...
  /* (mat1 + mat2)*vecBを計算 */
  template <typename Mat1, typename Mat2, typename DType1, typename DType2,
            typename DType0, typename DTypeA>
  static void productVecMat2(DTypeA **ans, const Mat1 &mat1, const Mat2 &mat2,
                             const DType0 *vecB);
  /* 行列AとBとCをかけて結果を返す*/
  template <typename Mat1, typename Mat2, typename Mat3, typename Mat0,
            typename DType1, typename DType2, typename DType3, typename DType0>
  static void MatProduct(Mat0 &mat_ans, const Mat1 &matA, const Mat2 &matB,
                         const Mat3 &matC);
  /**/
  /**/
  /* nonzero既知固定用 */
   ...
   */
  template <typename Mat1, typename Mat2, typename Mat0, typename DType1,
            typename DType2, typename DType0>
  static void PlusMinusShiftFix(Mat0 &matAB, const Mat1 &matA, const Mat2 &matB,
                                double a1, double a2, slv_int pos1,
                                slv_int pos2);
  /* (配列位置確定時)自身に、行列A±B±Cを加える(a1*A+a2*B+a3*C)。 */
  template <typename Mat1, typename Mat2, typename Mat3, typename Mat0,
            typename DType1, typename DType2, typename DType3, typename DType0>
  static void PlusMinusShiftFix(Mat0 &matABC, const Mat1 &matA,
                                const Mat2 &matB, const Mat3 &matC, double a1,
                                double a2, double a3);
  ...
  template <typename Mat1, typename Mat2, typename Mat3, typename Mat0,
            typename DType1, typename DType2, typename DType3, typename DType0>
  static void MatProductFix(Mat0 &matABC, const Mat1 &matA, const Mat2 &matB,
                            const Mat3 &matC);
  /**/
public:
  /* (a1*mat1 + a2*mat2)で、mat2に足す位置をpos1,pos2ずらすを計算 */
  static SparseMat plusShift(const SparseMat &mat1, const SparseMat &mat2,
                             const double a1, const double a2,
                             const slv_int pos1, const slv_int pos2);
  static SparseMatC plusShift(const SparseMatC &mat1, const SparseMatC &mat2,
                              const double a1, const double a2,
                              const slv_int pos1, const slv_int pos2);
  /* (mat1 + mat2)*vecBを計算 */
  static double *dotVecMat2(const SparseMat &mat1, const SparseMat &mat2,
                            const double *vec1);
  static dcomplex *dotVecMat2(const SparseMat &mat1, const SparseMatC &mat2,
                              const double *vec1);
  static dcomplex *dotVecMat2(const SparseMatC &mat1, const SparseMat &mat2,
                              const double *vec1);
  static dcomplex *dotVecMat2(const SparseMatC &mat1, const SparseMatC &mat2,
                              const double *vec1);
  static dcomplex *dotVecMat2(const SparseMat &mat1, const SparseMat &mat2,
                              const dcomplex *vec1);
  static dcomplex *dotVecMat2(const SparseMat &mat1, const SparseMatC &mat2,
                              const dcomplex *vec1);
  static dcomplex *dotVecMat2(const SparseMatC &mat1, const SparseMat &mat2,
  ...
  static dcomplex *dotVecMat2(const SparseMatC &mat1, const SparseMatC &mat2,
                              const dcomplex *vec1);
  /* 行列AとBとCをかけて結果を返す*/
  static SparseMat dotMats(const SparseMat &matA, const SparseMat &matB,
                           const SparseMat &matC);
  static SparseMatC dotMats(const SparseMat &matA, const SparseMat &matB,
                            const SparseMatC &matC);
  static SparseMatC dotMats(const SparseMat &matA, const SparseMatC &matB,
                            const SparseMatC &matC);
  static SparseMatC dotMats(const SparseMatC &matA, const SparseMatC &matB,
                            const SparseMatC &matC);
  /**/
  /* (配列位置確定時)自身に、行列A±Bを加える(a1*A+a2*B)。Bの開始位置はposだけずらす
   */
  static void plusFix(SparseMat &matAB, const SparseMat &matA,
                      const SparseMat &matB, double a1 = 1.0, double a2 = 1.0,
                      slv_int pos1 = 0, slv_int pos2 = 0);
  static void plusFix(SparseMatC &matAB, const SparseMat &matA,
                      const SparseMatC &matB, double a1 = 1.0, double a2 = 1.0,
                      slv_int pos1 = 0, slv_int pos2 = 0);
  static void plusFix(SparseMatC &matAB, const SparseMatC &matA,
                      const SparseMatC &matB, double a1 = 1.0, double a2 = 1.0,
                      slv_int pos1 = 0, slv_int pos2 = 0);
  /* (配列位置確定時)自身に、行列A±B±Cを加える(a1*A+a2*B+a3*C) */
  static void plusFix(SparseMat &matABC, const SparseMat &matA,
                      const SparseMat &matB, const SparseMat &matC,
                      double a1 = 1.0, double a2 = 1.0, double a3 = 1.0);
  static void plusFix(SparseMatC &matABC, const SparseMatC &matA,
                      const SparseMatC &matB, const SparseMatC &matC,
                      double a1 = 1.0, double a2 = 1.0, double a3 = 1.0);
  /* (配列位置確定時)行列AとBをかけて、自身ABに格納する */
  static void dotFix(SparseMat &matAB, const SparseMat &matA,
                     const SparseMat &matB);
  static void dotFix(SparseMatC &matAB, const SparseMat &matA,
                     const SparseMatC &matB);
  static void dotFix(SparseMatC &matAB, const SparseMatC &matA,
                     const SparseMatC &matB);
  /* (配列位置確定時)行列AとBとCをかけて、自身ABCに格納する */
  static void dotFix(SparseMat &matAB, const SparseMat &matA,
                     const SparseMat &matB, const SparseMat &matC);
  static void dotFix(SparseMatC &matAB, const SparseMat &matA,
                     const SparseMat &matB, const SparseMatC &matC);
  static void dotFix(SparseMatC &matAB, const SparseMat &matA,
                     const SparseMatC &matB, const SparseMatC &matC);
  static void dotFix(SparseMatC &matAB, const SparseMatC &matA,
                     const SparseMatC &matB, const SparseMatC &matC);
...
//=======================================================*/
template <typename Mat1, typename DType1, typename DType2, typename DType3>
void SparseMatOperators::mat_vec_product(DType3 **ans, const Mat1 &matA,
                                         const DType2 *const vec) {
...
//=======================================================*/
template <typename Mat1, typename DType3>
void SparseMatOperators::mat_vec_product(std::vector<DType3> &ans,
                                         const Mat1 &matA,
                                         const std::vector<double> &vec) {
...
template <typename Mat1>
void SparseMatOperators::mat_vec_product(std::vector<dcomplex> &ans,
                                         const Mat1 &matA,
                                         const std::vector<dcomplex> &vec) {
  const slv_int the_size = vec.size();
...
template <typename Mat1>
void SparseMatOperators::mat_vec_product(Eigen::VectorXcd &ans,
                                         const Mat1 &matA,
                                         const std::vector<dcomplex> &vec) {
  const slv_int the_size = vec.size();
  Eigen::VectorXcd vecE(the_size);
...
template <typename Mat1, typename Mat2, typename Mat3, typename DType1,
          typename DType2>
void SparseMatOperators::plus_operators(Mat3 &mat3, const Mat1 &matA,
                                        const Mat2 &matB, double a1, double a2,
                                        slv_int pos1, slv_int pos2) {
  /* 最大の行数を計算 */
...
template <typename Mat1, typename Mat2, typename DType1, typename DType2,
          typename DType3>
void SparseMatOperators::MatSelfPlus(Mat1 &matA, const Mat2 &matB,
                                     const DType3 a1, const slv_int pos1,
                                     const slv_int pos2) {
  if (matA.is_fix) {
    const slv_int max_size =
        (matA.size > matB.size + pos1 ? matA.size : matB.size + pos1);
...
template <typename Mat1, typename Mat2, typename DType1, typename DType2,
          typename DType0, typename DTypeA>
void SparseMatOperators::productVecMat2(DTypeA **ans, const Mat1 &mat1,
                                        const Mat2 &mat2, const DType0 *vecB) {
...
template <typename Mat1, typename Mat2, typename Mat3, typename Mat0,
          typename DType1, typename DType2, typename DType3, typename DType0>
void SparseMatOperators::MatProduct(Mat0 &mat_ans, const Mat1 &matA,
                                    const Mat2 &matB, const Mat3 &matC) {
...
//=======================================================*/
template <typename Mat1, typename DType>
void SparseMatOperators::makeSubMat(Mat1 &mat_ans, const Mat1 &targetMat,
                                    slv_int range1a, slv_int range1b,
                                    slv_int range2a, slv_int range2b) {
...
//=======================================================*/
template <typename Mat1, typename DType>
void SparseMatOperators::MatDiv(const Mat1 &targetMat, Mat1 &matK11,
                                Mat1 &matK12, slv_int rangeA, slv_int rangeB) {
  const slv_int the_size = targetMat.size;
...
//=======================================================*/
template <typename Mat1, typename DType1, typename DTypeD>
void SparseMatOperators::IC_decomp(Mat1 &mat_ans, const Mat1 &mat1,
                                   DTypeD *diagD, const double accela) {
  ...
  for (slv_int i = 0; i < the_size; i++) {
    ...
    // std::cout << "diag " << i << ", " << last << ", "<< col_ptr1[last] <<
    // std::endl;
    /* もし対角が無ければエラーで落とす */
    if (col_ptr1[last] != i) {
...
template <typename Mat1, typename Mat2, typename Mat0, typename DType1,
          typename DType2, typename DType0>
void SparseMatOperators::PlusMinusShiftFix(Mat0 &matAB, const Mat1 &matA,
                                           const Mat2 &matB, double a1,
                                           double a2, slv_int pos1,
                                           slv_int pos2) {
  if (!matAB.is_fix) {
    return;
  }
...
template <typename Mat1, typename Mat2, typename Mat3, typename Mat0,
          typename DType1, typename DType2, typename DType3, typename DType0>
void SparseMatOperators::PlusMinusShiftFix(Mat0 &matABC, const Mat1 &matA,
                                           const Mat2 &matB, const Mat3 &matC,
...
template <typename Mat1, typename Mat2, typename Mat0, typename DType1,
          typename DType2, typename DType0>
void SparseMatOperators::MatProductFix(Mat0 &matAB, const Mat1 &matA,
                                       const Mat2 &matB) {
  if (!matAB.is_fix) {
    return;
  }
...
template <typename Mat1, typename Mat2, typename Mat3, typename Mat0,
          typename DType1, typename DType2, typename DType3, typename DType0>
void SparseMatOperators::MatProductFix(Mat0 &matABC, const Mat1 &matA,
                                       const Mat2 &matB, const Mat3 &matC) {
  if (!matABC.is_fix) {
    return;
  }
