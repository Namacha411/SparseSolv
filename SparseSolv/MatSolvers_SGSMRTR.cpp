...
//=======================================================*/
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  norm = sqrt(norm);
  bool bl = solveSGSMRTR(size0, conv_cri, max_ite, norm, matA, vecBa, results_a,
                         init);
  for (slv_int i = 0; i < size0; i++) {
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  norm = sqrt(norm);
  bool bl =
      solveSGSMRTR(size0, conv_cri, max_ite, norm, matA, vecBa, results, init);
  delete[] vecBa;
  return bl;
}
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  bool bl = solveSGSMRTR(size0, conv_cri, max_ite, normB, matDAD.matrix,
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  return solveSGSMRTR(size, conv_cri, max_ite, norm00, matA, vecB, results,
                      init);
}
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  double norm0 = abs(norm);
  double norm00 = sqrt(norm0);
  bool bl = solveSGSMRTR(size0, conv_cri, max_ite, norm00, matA, vecBa,
                         results_a, init);
  for (slv_int i = 0; i < size0; i++) {
    results[i] = results_a[i];
  }
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  double norm0 = abs(norm);
  double norm00 = sqrt(norm0);
  bool bl = solveSGSMRTR(size0, conv_cri, max_ite, norm00, matA, vecBa, results,
                         init);
  delete[] vecBa;
  return bl;
}
...
bool MatSolvers::solveSGSMRTR(const slv_int size0, const double conv_cri,
  ...
  bool bl = solveSGSMRTR(size0, conv_cri, max_ite, norm00, matDAD.matrix,
                         matL.matrix, matL_tr.matrix, vecB2, results, init);
  delete[] vecB2;
  /* 元に戻す */
...
// ● MRTRで解く（本体）
//=======================================================*/
bool MatSolvers::solveSGSMRTR(const slv_int size, const double conv_cri,
                              const int max_ite, const double normB,
                              const SparseMatBaseD &matA,
