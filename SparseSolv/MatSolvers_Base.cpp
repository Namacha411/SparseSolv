...
// ● IC 前進後退代入
//=======================================================*/
void MatSolvers::IC_frbc_process(const slv_int size0,
                                 const SparseMatBaseD &matL,
                                 const SparseMatBaseD &matL_tr,
                                 const double *diagD, const double *vecR,
                                 double *vec) {
...
void MatSolvers::IC_frbc_process(const slv_int size0,
                                 ...
                                 const dcomplex *diagD, const dcomplex *vecR,
                                 dcomplex *vec) {
  const slv_int size = size0;
  // dcomplex s;
...
void MatSolvers::IC_frbc_process(const slv_int size0,
                                 const SparseMatBaseC &matL,
                                 const SparseMatBaseC &matL_tr,
                                 const dcomplex *diagD,
                                 const Eigen::VectorXcd &EvecR,
                                 Eigen::VectorXcd &vec) {
  const slv_int size = size0;
  // dcomplex s;
...
// ● 前進代入
//=======================================================*/
void MatSolvers::fr_process(const slv_int size0, const SparseMatBaseD &matL,
...
// ● 前進代入
//=======================================================*/
void MatSolvers::fr_process(const slv_int size0, const SparseMatBaseC &matL,
...
// ● 後退代入
//=======================================================*/
void MatSolvers::bc_process(const slv_int size0, const SparseMatBaseD &matL_tr,
                            const double *vecR, double *vec) {
  const slv_int size = size0;
  // double s;
...
// ● 後退代入
//=======================================================*/
void MatSolvers::bc_process(const slv_int size0, const SparseMatBaseC &matL_tr,
                            const dcomplex *vecR, dcomplex *vec) {
  const slv_int size = size0;
  // dcomplex s;
